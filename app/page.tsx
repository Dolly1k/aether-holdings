  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative">
      ...
      <section className="min-h-screen flex items-center pt-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-10 text-center relative z-10">
          <div className="inline-flex items-center gap-3 border border-emerald-900/60 text-emerald-300 text-[10px] tracking-[4px] px-4 sm:px-6 py-2 mb-10 sm:mb-12">
            ...
            {t('est2019Badge')} • {t('privateByDesign')}
            <span className="w-1 h-1 rounded-full bg-emerald-400"></span>
          </div>

          <h1 className="text-[52px] sm:text-[68px] lg:text-[96px] leading-[0.9] font-medium tracking-[-0.04em] mb-6 sm:mb-8 text-white">
          ...
          <div className="mt-16 sm:mt-20 text-[10px] tracking-[3px] text-white/30">
            {t('exclusiveBadge')}
          </div>
        </div>
      </section>
      ...
      <section id="investments" className="py-20 sm:py-32 border-t border-white/10 relative">
        <div className="max-w-6xl mx-auto px-5 sm:px-10">
          <div className="text-center mb-14 sm:mb-24">
            ...
            <h2 className="text-3xl sm:text-5xl font-light tracking-tight">{t('gradesTitle')}</h2>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10">
            {tiers.map(tier => (
              <div key={tier.grade} className="group p-6 sm:p-8 lg:p-10 bg-[#050505] hover:bg-zinc-950 transition-all">
      ...
      <section id="mandate" className="py-20 sm:py-32 border-t border-white/10 relative bg-zinc-950/30">
        <div className="max-w-6xl mx-auto px-5 sm:px-10 grid lg:grid-cols-12 gap-10 sm:gap-16 items-center">
          <div className="lg:col-span-5">
            <div className="text-emerald-400 text-[10px] tracking-[3px] mb-4">{t('globalMandate')}</div>
